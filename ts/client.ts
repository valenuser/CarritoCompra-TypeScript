const cards: HTMLElement = <HTMLElement> document.getElementById('card-space')
const cardSelected: HTMLElement = <HTMLElement> document.getElementById('card-selected')
const price: HTMLElement = <HTMLElement> document.getElementById('price'),
...
let productsSelected: (CardsProducts | undefined)[] = []


function deleteProduct(data: number){
   ...
   productsSelected = productsSelected.filter(n => n?.id != data)

   const dataPriceProduct = products.find(n => n?.id == data)
...
function addProduct(data: number){
